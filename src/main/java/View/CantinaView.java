...
public class CantinaView extends Application implements Observador {
    ...
    public void start(Stage primaryStage) {
        ...
        criarObstaculo(584.0, 657.5, 139.0, 170.0, mundoBox);
        criarObstaculo(321.0, 665.5, 143.0, 164.0, mundoBox);
        criarObstaculo(294.0, 460.5, 171.0, 187.0, mundoBox);
        criarObstaculo(296.0, 260.5, 106.0, 160.0, mundoBox);
        criarObstaculo(403.0, 234.5, 54.0, 187.0, mundoBox);
        ...
        criarObstaculo(810.0, 911.5, 130.0, 24.0, mundoBox);
        criarObstaculo(1161.0, 913.5, 84.0, 23.0, mundoBox);
        criarObstaculo(1175.0, 755.5, 71.0, 84.0, mundoBox);
        criarObstaculo(947.0, 665.5, 162.0, 162.0, mundoBox);
        criarObstaculo(1331.0, 781.5, 175.0, 147.0, mundoBox);
        criarObstaculo(1561.0, 792.5, 38.0, 143.0, mundoBox);
        criarObstaculo(1539.0, 91.5, 60.0, 139.0, mundoBox);
        criarObstaculo(-10, 0, 10, mapH, mundoBox);
        criarObstaculo(mapW, 0, 10, mapH, mundoBox);
        criarObstaculo(0, mapH - 20, mapW, 30, mundoBox);
        criarObstaculo(14.0, 0.5, 711.0, 39.0, mundoBox);
        criarObstaculo(735.0, 2.5, 37.0, 68.0, mundoBox);
